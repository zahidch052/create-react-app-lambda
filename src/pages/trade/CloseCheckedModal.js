...
const CloseCheckedModal = (props) => {
    return (
        <ModalComponent
            size="md"
            show={true}
            handleClose={props.closeCheckedModalHandler}
            title="Trade"
        >
            <Modal.Body >
                <div className="row ps-4 pe-4">
                    <div className="col-lg-12">
                        <p className="fs-18 fw-550" >Do You Want To Close Checked Trades</p>
...
export default CloseCheckedModal