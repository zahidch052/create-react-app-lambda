...
const RoboOrderHistoryModal = (props) => {
    return (
        <>
            <ModalComponent
                size="xl"
                ...
                title="Robo Order History Report"
            >
                            ...
                            <div className='d-flex align-items-center gap-3'>
                                <div className='d-flex align-items-center gap-3'>
                                    ...
                                    <div className='d-flex align-items-center gap-3'>
                                        ...
                                        <label for="demoAccount" className='checkboxLabel fs-14 fw-500 black'>Ignore Same Price</label>
                                    </div>
                                </div>
                                <div className='d-flex align-items-center gap-3'>
                                    <input type="checkbox" id="demoAccount" className='modalChecbox' />
...
export default RoboOrderHistoryModal