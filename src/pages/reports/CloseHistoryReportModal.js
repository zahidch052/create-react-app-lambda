...
const CloseHistoryReportModal = (props) => {
    return (
        <>
            <ModalComponent
                size="xl"
                        ...
                        <div className="col-md-5">
                            ...
                            <div className='d-flex align-items-center gap-4 mt-3'>
                                <div className='d-flex align-items-center gap-3 w-75'>
                                    <input type="checkbox" id="demoAccount" className='modalChecbox' />
                                    <label for="demoAccount" className='checkboxLabel fs-14 fw-500 black'>Ignore Zero Open Commission</label>
                                </div>
                                <div className='d-flex align-items-center gap-3'>
                                    <input type="checkbox" id="demoAccount" className='modalChecbox' />
                                    <label for="demoAccount" className='checkboxLabel fs-14 fw-500 black'>Ignore Zero Close
                                        Commission</label>
                                </div>
                            </div>
                        </div>
...
export default CloseHistoryReportModal